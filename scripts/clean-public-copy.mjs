...
const replacements = [
  ...
  ["RFA's framework describes outcomes across four connected areas. Open any area to see the complete set of expectations.", "RFA's expected student outcomes are organised across four connected areas. Open any area to see the complete set of expectations."],
  ["RFA published a High School planning ratio of approximately 15 learners to 1 teacher.", "The High School planning ratio is approximately 15 learners to 1 teacher."],
  ...
  ["RFA published planning ratios of approximately 10:1 in Nursery and 12:1 in Primary.", "Planning ratios are approximately 10:1 in Nursery and 12:1 in Primary."],
  ...
  ["RFA states that learners from other faith backgrounds may be admitted while the school's Christian identity and programme remain clearly expressed.", "Learners from other faith backgrounds may be admitted while the school's Christian identity and programme remain clearly expressed."],
  ["RFA states that the Academy serves both Nigerian and international students.", "RFA serves both Nigerian and international students."],
  ["Published facilities include", "Facilities include"],
  ["Published language provision includes", "Language provision includes"],
  ["Practical information for learners and families is presented here in a compact form.", "Practical information for learners and families is presented here in a compact form."],
  ["Practical information on uniform, visitors, the school day and policies is presented here in a compact form.", "Practical information on uniform, visitors, the school day and policies is presented here in a compact form."],
  ["Requests for a particular teacher or class are not normally accommodated.", "Requests for a particular teacher or class are not normally accommodated."],
  ...
  ["RFA has a long tradition of practical outreach to families and communities, alongside an organised alumni network.", "RFA has a long tradition of practical outreach to families and communities, alongside an organised alumni network."],
  ["RFA has a long tradition of practical outreach to families and communities.", "RFA has a long tradition of practical outreach to families and communities."],
  ["RFA states that the RFA Alumni Association was formally established on 27 July 2019 and had grown to more than 250 Royal Ambassadors. Because office holders can change, current alumni leadership should be confirmed before relying on historical officer names.", "The RFA Alumni Association was formally established on 27 July 2019 and grew to more than 250 Royal Ambassadors."],
  ["RFA states that the RFA Alumni Association was formally established on 27 July 2019 and had grown to more than 250 Royal Ambassadors.", "The RFA Alumni Association was formally established on 27 July 2019 and grew to more than 250 Royal Ambassadors."],
  ...
  ["RFA", "RFA"],
  ["RFA", "RFA"],
  ["RFA's framework", "RFA's framework"],
  ["RFA's framework", "RFA's framework"],
